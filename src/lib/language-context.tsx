...
const translations = {
  en: {
    ...
    "auth.signInSubtitle": "Sign in to continue your Japanese learning journey",
    "auth.signUpSubtitle": "Start your Japanese learning adventure today",
    ...
    "course.courseNotFound": "Course not found",
    "course.reviewsCount": "reviews",
    "course.students": "students",
    "course.hours": "hours",
    "course.lessons": "lessons",
    "course.previewCourse": "Preview Course",
    "course.limitedTimeOffer": "Limited time offer",
    "course.startLearningNow": "Start Learning Now",
    "course.like": "Like",
    "course.liked": "Liked",
    "course.share": "Share",
    "course.lifetimeAccess": "Lifetime access",
    "course.mobileAndDesktop": "Mobile and desktop",
    "course.certificateOfCompletion": "Certificate of completion",
    "course.downloadableResources": "Downloadable resources",
    "course.overview": "Overview",
    "course.curriculum": "Curriculum",
    "course.instructor": "Instructor",
    "course.reviews": "Reviews",
    "course.aboutThisCourse": "About This Course",
    "course.whatYoullLearn": "What You'll Learn",
    "course.requirements": "Requirements",
    "course.courseCurriculum": "Course Curriculum",
    "course.lessonsTotal": "lessons",
    "course.hoursTotal": "hours total",
    "course.meetYourInstructor": "Meet Your Instructor",
    "course.rating": "rating",
    "course.studentReviews": "Student Reviews",
    "course.basedOnReviews": "Based on",
  ...
  vi: {
    ...
    "auth.signInSubtitle": "Đăng nhập để tiếp tục hành trình học tiếng Nhật của bạn",
    "auth.signUpSubtitle": "Bắt đầu cuộc phiêu lưu học tiếng Nhật của bạn ngay hôm nay",
    "auth.fullName": "Họ và tên",
    "auth.email": "Email",
    "auth.password": "Mật khẩu",
    "auth.confirmPassword": "Xác nhận mật khẩu",
    "auth.enterFullName": "Nhập họ và tên của bạn",
    ...
    "auth.createOneNow": "Tạo ngay",
    "auth.signInInstead": "Đăng nhập thay vào đó",

    // Course Preview
    "course.backToCourses": "Quay lại khóa học",
    "course.courseNotFound": "Không tìm thấy khóa học",
    "course.reviewsCount": "đánh giá",
    "course.students": "học viên",
    "course.hours": "giờ",
    "course.lessons": "bài học",
    "course.previewCourse": "Xem trước khóa học",
    "course.limitedTimeOffer": "Ưu đãi có thời hạn",
    "course.startLearningNow": "Bắt đầu học ngay",
    "course.like": "Thích",
    "course.liked": "Đã thích",
    "course.share": "Chia sẻ",
    "course.lifetimeAccess": "Truy cập trọn đời",
    "course.mobileAndDesktop": "Di động và máy tính",
    "course.certificateOfCompletion": "Chứng chỉ hoàn thành",
    "course.downloadableResources": "Tài nguyên có thể tải xuống",
    "course.overview": "Tổng quan",
    "course.curriculum": "Chương trình học",
    "course.instructor": "Giảng viên",
    "course.reviews": "Đánh giá",
    "course.aboutThisCourse": "Về khóa học này",
    "course.whatYoullLearn": "Bạn sẽ học được gì",
    "course.requirements": "Yêu cầu",
    "course.courseCurriculum": "Chương trình khóa học",
    "course.lessonsTotal": "bài học",
    "course.hoursTotal": "giờ tổng cộng",
    "course.meetYourInstructor": "Gặp gỡ giảng viên của bạn",
    "course.rating": "đánh giá",
    "course.studentReviews": "Đánh giá của học viên",
    "course.basedOnReviews": "Dựa trên",
    "course.courseFeatures": "Tính năng khóa học",
    "course.relatedCourses": "Khóa học liên quan",

...
export default function AIPracticePage() {
  const [messages, setMessages] = useState([
    {
      role: "ai",
      content: "Xin ch├áo! T├┤i l├á trß╗ú l├╜ hß╗ìc tß║¡p AI cß╗ºa bß║ín. ≡ƒæï",
    },
    {
      role: "ai",
      content:
        "Dß╗▒a tr├¬n dß╗» liß╗çu hß╗ìc tß║¡p, h├┤m nay bß║ín n├¬n ├┤n lß║íi phß║ºn flashcard vß╗ü thß╗¥i gian.",
    },
  ]);
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        {
          role: "ai",
          content:
            "T├┤i ─æ├ú nhß║¡n ─æ╞░ß╗úc tin nhß║»n cß╗ºa bß║ín. ─É├óy l├á n╞íi bß║ín sß║╜ kß║┐t nß╗æi vß╗¢i AI backend ─æß╗â xß╗¡ l├╜ c├óu hß╗Åi.",
        },
      ]);
    }, 1000);
  ...
  const skillRadarData = [
    { skill: "Ngß╗» ph├íp", value: 78 },
    { skill: "Tß╗½ vß╗▒ng", value: 85 },
    { skill: "Kanji", value: 65 },
    { skill: "Nghe", value: 72 },
    { skill: "─Éß╗ìc", value: 80 },
    { skill: "Viß║┐t", value: 70 },
  ];

  const flashcardDistribution = [
    { name: "Th├ánh thß║ío", value: 156, color: "#22c55e" },
    { name: "─Éang hß╗ìc", value: 89, color: "#3b82f6" },
    { name: "Kh├│ nhß╗¢", value: 23, color: "#f97316" },
  ];
      ...
      >
          ...
          <Card className="border-primary/20 shadow-sm hover:shadow-lg hover:scale-105 transition-all duration-300 animate-in fade-in slide-in-from-bottom-4">
            <CardHeader className="pb-3">
              <CardTitle className="text-xs sm:text-sm font-medium flex items-center gap-2">
                ...
                <span className="hidden sm:inline">Tr├¼nh ─æß╗Ö</span>
              </CardTitle>
            </CardHeader>
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">Trung cß║Ñp</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-primary/20 shadow-sm hover:shadow-lg hover:scale-105 transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 delay-75">
            <CardHeader className="pb-3">
              <CardTitle className="text-xs sm:text-sm font-medium flex items-center gap-2">
                ...
                <span className="hidden sm:inline">Tiß║┐n bß╗Ö</span>
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-primary/20 shadow-sm hover:shadow-lg hover:scale-105 transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 delay-200">
            <CardHeader className="pb-3">
              <CardTitle className="text-xs sm:text-sm font-medium flex items-center gap-2">
                ...
                <span className="hidden sm:inline">Ghi nhß╗¢</span>
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className="shadow-sm animate-in fade-in slide-in-from-bottom-4 delay-300">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-sm sm:text-base">
              ...
              Tiß║┐n ─æß╗Ö tuß║ºn n├áy
            </CardTitle>
            <CardDescription className="text-xs sm:text-sm">
              Thß╗¥i gian hß╗ìc v├á ─æß╗Ö ch├¡nh x├íc theo ng├áy
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="shadow-sm animate-in fade-in slide-in-from-bottom-4 delay-400">
          <CardHeader>
            ...
            <CardDescription className="text-xs sm:text-sm">
              ─É├ính gi├í to├án diß╗çn c├íc kß╗╣ n─âng tiß║┐ng Nhß║¡t
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="shadow-sm animate-in fade-in slide-in-from-bottom-4 delay-500">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-sm sm:text-base">
              ...
              Tiß║┐n ─æß╗Ö kh├│a hß╗ìc
            </CardTitle>
            <CardDescription className="text-xs sm:text-sm">
              C├íc kh├│a hß╗ìc ─æang hß╗ìc v├á mß╗⌐c ─æß╗Ö ho├án th├ánh
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2 group hover:bg-muted/50 p-3 rounded-lg transition-colors">
              <div className="flex justify-between text-sm">
                <span className="font-medium">Hiragana c╞í bß║ún</span>
              ...
              <p className="text-xs text-muted-foreground">
                Thß╗¥i gian trung b├¼nh: 2.5 giß╗¥/tuß║ºn
              </p>
            </div>

            <div className="space-y-2 group hover:bg-muted/50 p-3 rounded-lg transition-colors">
              <div className="flex justify-between text-sm">
                <span className="font-medium">Katakana n├óng cao</span>
              ...
              />
              <p className="text-xs text-muted-foreground">
                Thß╗¥i gian trung b├¼nh: 1.8 giß╗¥/tuß║ºn
              </p>
            </div>
            ...
            <div className="space-y-2 group hover:bg-muted/50 p-3 rounded-lg transition-colors">
              ...
              <p className="text-xs text-orange-600">
                ΓÜá∩╕Å ─Éang gß║╖p kh├│ kh─ân - Cß║ºn ├┤n tß║¡p th├¬m
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-sm animate-in fade-in slide-in-from-bottom-4 delay-800">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-2 sm:gap-4">
              ...
              <div className="p-3 sm:p-4 bg-muted/50 rounded-lg hover:bg-muted hover:scale-105 transition-all">
                <p className="text-xs text-muted-foreground">
                  ─Éß╗Ö d├ái phi├¬n hß╗ìc TB
                </p>
                <p className="text-base sm:text-lg font-bold mt-1">45 ph├║t</p>
              </div>
              <div className="p-3 sm:p-4 bg-muted/50 rounded-lg hover:bg-muted hover:scale-105 transition-all">
                <p className="text-xs text-muted-foreground">Chuß╗ùi ng├áy hß╗ìc</p>
                <p className="text-base sm:text-lg font-bold mt-1">
                  12 ng├áy ≡ƒöÑ
                </p>
                <p className="text-xs text-muted-foreground mt-1">
                  D├ái nhß║Ñt: 28 ng├áy
                </p>
              </div>
              <div className="p-3 sm:p-4 bg-muted/50 rounded-lg hover:bg-muted hover:scale-105 transition-all">
                <p className="text-xs text-muted-foreground">
                  Nß╗Öi dung y├¬u th├¡ch
                </p>
                <p className="text-base sm:text-lg font-bold mt-1">
                  Flashcards
                </p>
        ...
        <Card className="shadow-sm border-primary/30 animate-in fade-in slide-in-from-bottom-4 delay-900">
          <CardHeader>
            ...
            <CardDescription className="text-xs sm:text-sm">
              Dß╗▒a tr├¬n ph├ón t├¡ch hß╗ìc tß║¡p cß╗ºa bß║ín
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-xs sm:text-sm">
                    ├ön lß║íi flashcard N5 vß╗ü thß╗¥i gian
                  </p>
                  <p className="text-xs text-muted-foreground mt-1">
                    Bß║ín ─æ├ú kh├┤ng ├┤n phß║ºn n├áy trong 3 ng├áy. Tß╗╖ lß╗ç ghi nhß╗¢ c├│ thß╗â
                    giß║úm.
                  </p>
                </div>
              </div>
            ...
            <div className="p-3 sm:p-4 bg-primary/5 border border-primary/20 rounded-lg hover:bg-primary/10 hover:scale-105 transition-all cursor-pointer">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-xs sm:text-sm">
                    L├ám b├ái luyß╗çn ngß╗» ph├íp N4
                  </p>
                  <p className="text-xs text-muted-foreground mt-1">
                    ─Éiß╗âm ngß╗» ph├íp cß╗ºa bß║ín ─æang thß║Ñp h╞ín trung b├¼nh. H├úy luyß╗çn
                    tß║¡p th├¬m!
                  </p>
                </div>
              </div>
            ...
            <div className="p-3 sm:p-4 bg-primary/5 border border-primary/20 rounded-lg hover:bg-primary/10 hover:scale-105 transition-all cursor-pointer">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-xs sm:text-sm">
                    Thß╗¡ hß╗ìc Kanji theo chß╗º ─æß╗ü
                  </p>
                  <p className="text-xs text-muted-foreground mt-1">
                    Bß║ín hß╗ìc tß╗æt h╞ín khi Kanji ─æ╞░ß╗úc nh├│m theo chß╗º ─æß╗ü thay v├¼ theo
                    thß╗⌐ tß╗▒.
                  </p>
                </div>
              </div>
            ...
            <Card className="flex-1 flex flex-col shadow-lg">
              <CardHeader className="border-b bg-primary/5">
                <CardTitle className="flex items-center gap-2 text-sm sm:text-base">
                  ...
                  Trß╗ú l├╜ hß╗ìc tß║¡p AI ≡ƒñû
                </CardTitle>
                <CardDescription className="text-xs sm:text-sm">
                  Hß╗Åi bß║Ñt cß╗⌐ ─æiß╗üu g├¼ vß╗ü viß╗çc hß╗ìc tiß║┐ng Nhß║¡t
                </CardDescription>
              </CardHeader>
              ...
              <div className="p-3 sm:p-4 border-t bg-muted/30">
                <div className="flex gap-2">
                  <Input
                    placeholder="Nhß║¡p c├óu hß╗Åi cß╗ºa bß║ín..."
                    value={inputMessage}
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  ≡ƒÆí Tip: Hß╗Åi vß╗ü ngß╗» ph├íp, tß╗½ vß╗▒ng, hoß║╖c y├¬u cß║ºu gß╗úi ├╜ hß╗ìc tß║¡p
                </p>
              </div>
            </Card>
          </div>

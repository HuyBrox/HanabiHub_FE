...
const lessons = [
  { id: 1, title: "Introduction to Hiragana", duration: "5 min", completed: true },
    ...
    <div className="flex h-screen bg-background">
      ...
      <div className="w-80 bg-card border-r border-border overflow-y-auto">
        <div className="p-6 border-b border-border">
          ...
          <p className="text-sm text-muted-foreground">Master all 46 hiragana characters</p>
          <div className="mt-4">
            ...
            {lessons.map((lesson) => (
              <button
                ...
                className={cn(
                  ...
                  currentLesson === lesson.id ? "bg-primary/10 border border-primary/20" : "hover:bg-muted/50",
                )}
              >
                {lesson.completed ? (
                ...
                {currentLesson === lesson.id && <ChevronRight className="h-4 w-4 text-primary" />}
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="bg-black relative">
          <div className="aspect-video bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center">
            <div className="text-center text-white">
              ...
              <h3 className="text-xl font-semibold mb-2">{lessons.find((l) => l.id === currentLesson)?.title}</h3>
          ...
          <div className="flex-1 p-6 overflow-y-auto">
            <div className="max-w-2xl">
              <div className="mb-6">
                ...
                <h1 className="text-2xl font-bold mb-2">{lessons.find((l) => l.id === currentLesson)?.title}</h1>
                <p className="text-muted-foreground">Practice what you've learned with these interactive exercises.</p>
              </div>

              <Card>
                <CardHeader>
                  <CardTitle>Practice Quiz</CardTitle>
                  <CardDescription>Test your knowledge of the characters you just learned.</CardDescription>
                </CardHeader>
                        ...
                        {question.options.map((option, optionIndex) => (
                          <button
                            ...
                            className={cn(
                              ...
                              showResults && optionIndex === question.correct && "border-green-500 bg-green-50",
                              showResults &&
                                selectedAnswers[questionIndex] === optionIndex &&
                  ...
                  <div className="pt-4">
                    {!showResults ? (
                      ...
                      <div className="flex gap-3">
                        ...
                        <Button className="bg-primary hover:bg-primary/90">Continue to Next Lesson</Button>
                      </div>
                    )}
                  </div>
                </CardContent>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-semibold text-primary">{completedLessons}</p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Remaining</p>
                      <p className="font-semibold">{lessons.length - completedLessons}</p>
                    </div>
                  </div>
                </div>
